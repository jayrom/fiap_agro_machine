...
void loop() {
  ...
  // Saída das variáveis para monitoramento no serial plotter.
  Serial.print(phosphorusRawValue);
  Serial.print(","); 
  Serial.println(potassiumRawValue);
  ...
  // Serializa JSON para string (char array)
